...
public class LoginStepOneRemoteDataSource {
    ...
    public void loginStepOne(LoginStepOne loginStepOne, final DataSourceListener<LoginStepOneResponse> dataSourceListener) {

        LoginStepOneRequest loginStepOneRequest = new LoginStepOneRequest(loginStepOne.getNumber(),loginStepOne.getAndroidId(),

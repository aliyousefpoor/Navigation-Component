...
public class LoginStepTwoRemoteDataSource {
    ...
    public void loginStepTwo(LoginStepTwo loginStepTwo, final DataSourceListener<LoginStepTwoResponse> dataSourceListener) {
        LoginStepTwoRequest verification = new LoginStepTwoRequest(loginStepTwo.getNumber(),loginStepTwo.getAndroidId(),loginStepTwo.getCode());
